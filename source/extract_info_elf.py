...
print "Writing import table to file ", idaapi.get_input_file_path() + "_import_name.pkl"
pickle.dump(import_table, open(idaapi.get_input_file_path() + "_import_name.pkl", "w"))
pickle.dump(import_table_info, open(idaapi.get_input_file_path() + "_import_info.pkl", "w"))
...
export_file = idaapi.get_input_file_path() + "_export_name.pkl"
...
print "Writing binary info to file ", idaapi.get_input_file_path() + "_info.pkl"
f = open(idaapi.get_input_file_path() + "_info.pkl", "w")
...
lib_or_thunk_file = idaapi.get_input_file_path() + "_lib_or_thunk.pkl"
